                          ...
                          <tr key={index} className="border-b hover:bg-slate-50">
                            ...
                            <td className="p-4 text-center">
                              <span className={`px-3 py-1 rounded-full font-semibold ${
                                item.current < 0 ? 'bg-red-200 text-red-900' : 'bg-red-100 text-red-800'
                              }`}>
                                {item.current}
                              </span>
                            </td>
                            ...
                            <td className="p-4 text-center">
                              <span className={`px-3 py-1 rounded-full font-semibold ${
                                item.deficit > 50 ? 'bg-red-500 text-white' : 
                                item.deficit > 30 ? 'bg-orange-500 text-white' : 
                                'bg-yellow-500 text-white'
                              }`}>
                                {item.deficit > 50 ? 'CRITICAL' : item.deficit > 30 ? 'URGENT' : 'HIGH'}
                              </span>
                            </td>
                          </tr>
                        ))}
                    ...
                    <tbody>
                      {quarterlyPredictions.map((item, index) => (
                        <tr key={index} className="border-b hover:bg-slate-50">
                          ...
                          <td className="p-4 text-center">
                            <span className={`px-3 py-1 rounded-full font-semibold ${
                              item.currentStock < 0 ? 'bg-red-200 text-red-900' : 'bg-slate-200'
                            }`}>
                              {item.currentStock}
                            </span>
                          </td>
